...
* **CW Abbrevs**: Zufällige Abkürzungen und Q-gruppen, die im CW-Funkverkehr sehr häufig vorkommen (durch eine Parametereinstellung kann man die maximale Länge der zu trainierenden Abkürzungen wählen). Siehe <<appendix6>>, dort findete man eine Liste der Abkürzungen, die erzeugt werden können.
...
=== Anhang 6: Liste der von Morserino-32 verwendeten üblichen CW Abkürzungen[[appendix6]]
