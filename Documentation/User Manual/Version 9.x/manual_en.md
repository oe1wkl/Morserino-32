...
[A **triple click of the FN button** toggles the text in the scrolling
display area between its normal size and a smaller size that fits more
characters per line. This setting is remembered across power cycles.]{.pocket}
...
| []{.pocket}Font Size | Size of the text in the scrolling display area (and in menus and other screens using the same area): Normal, or Small for more characters per line. Same setting reachable via a triple click of the FN button — see section **Using the ENCODER Knob and FN Button**. | **Normal** / Small |
