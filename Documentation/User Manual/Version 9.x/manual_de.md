...
[Ein **Dreifachklick auf die FN-Taste** schaltet die Schrift im
Scrollbereich zwischen der normalen und einer kleineren, kompakteren
Größe um, die mehr Zeichen pro Zeile darstellt. Diese Einstellung bleibt
auch nach dem Ausschalten erhalten.]{.pocket}
...
| []{.pocket}**Font Size** | Größe der Schrift im Scrollbereich (sowie in Menüs und anderen Anzeigen, die denselben Bereich nutzen): Normal oder Small für mehr Zeichen pro Zeile. Dieselbe Einstellung ist auch per Dreifachklick der FN-Taste erreichbar — siehe Abschnitt **Verwendung von ENCODER und FN-Taste**. | **Normal** / Small |
