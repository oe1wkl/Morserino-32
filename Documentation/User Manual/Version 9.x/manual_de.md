...
| **Boost Practice** | Erhöht die Wahrscheinlichkeit, dass Zeichen aus deinem **Practice Set** (siehe **Einstellungen zum Practice Set** oben) beim Erzeugen von Zufallszeichen-Gruppen vorkommen – zusätzlich zu der oben gewählten **Random Groups**-Teilmenge. Wirkt sich nur auf Zufallszeichen aus – Wörter, Abkürzungen, Rufzeichen und der Koch Trainer sind davon nicht betroffen. Hat keine Wirkung, solange kein Practice Set festgelegt ist; ein Practice-Set-Zeichen, das außerhalb der aktuellen **Random Groups**-Teilmenge liegt (z. B. eine Ziffer, wenn nur Alpha ausgewählt ist), wird dadurch nicht zusätzlich eingemischt. | **Off** / Moderate / Strong |
