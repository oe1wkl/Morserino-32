...
| **Font Size** | Größe der Schrift im Scrollbereich (sowie in Menüs und anderen Anzeigen, die denselben Bereich nutzen): Normal oder Small für mehr Zeichen pro Zeile. Dieselbe Einstellung ist auch per Dreifachklick der FN-Taste erreichbar — siehe Abschnitt **Verwendung von ENCODER und FN-Taste**. | **Normal** / Small |
