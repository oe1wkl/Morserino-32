...
Die Option "Everything" zeigt sowohl gegebene als auch dekodierte Zeichen, sowie alle im CW Generator oder Echo Trainer generierten Ausgaben an. | **Keyer** / Decoder / Keyer+Decoder / ERRORS only
|===
