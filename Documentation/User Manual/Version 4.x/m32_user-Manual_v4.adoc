...
The option "Everything" displays both keyed and decoded characters, and also all output generated in CW Generator or Echo Trainer.  See also <<appendix5>>.| Keyer / Decoder / Keyer+Decoder / **Everything** (default since 4.3) / ERRORS only
|===
