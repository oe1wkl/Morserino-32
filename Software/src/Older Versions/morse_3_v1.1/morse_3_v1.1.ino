...
enum prefPos  { posClicks, posPitch, posExtPaddles, posPolarity, 
                ...
                posKochFilter, posLatency, posRandomFile };
...
const String prefOption[] = { "Encoder Click", "Tone Pitch Hz", "Paddle:      ", "Paddle Polar.", 
                              ...
                              "Koch         ", "Latency      ", "Randomize File"};                   
 prefPos keyerOptions[] =      {posClicks, posPitch, posExtPaddles, posPolarity, posLatency, posCurtisMode, posCurtisBDahTiming, posCurtisBDotTiming, posACS };
 ...
 prefPos playerOptions[] =     {posClicks, posPitch, posExtPaddles, posInterWordSpace, posInterCharSpace, posTrainerDisplay, 
                                     posRandomFile, posWordDoubler, posKeyTrainerMode, posLoraTrainerMode };
 prefPos echoPlayerOptions[] = {posClicks, posPitch, posExtPaddles, posPolarity, posLatency, posCurtisMode, posCurtisBDahTiming, posCurtisBDotTiming, posACS,
                                    posEchoToneShift, posInterWordSpace, posInterCharSpace, posRandomFile, posEchoRepeats,  posEchoConf};
 ...
 prefPos allOptions[] =        { posClicks, posPitch, posExtPaddles, posPolarity, posLatency,
                                    ...
                                    posEchoToneShift, posInterWordSpace, posInterCharSpace, posRandomOption, 
                                    posRandomLength, posCallLength, posAbbrevLength, posWordLength, 
                                    posTrainerDisplay, posRandomFile, posWordDoubler, posEchoRepeats,  posEchoConf, 
                                    posKeyTrainerMode, posLoraTrainerMode, posGoertzelBandwidth, posSpeedAdapt};
...
// we MUST reset the OLED RST pin for 50 ms! for the oldboard only, but as it does not hurt we do it anyway
//#if BOARDVERSION == 2
