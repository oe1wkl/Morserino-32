...
////////////  Check if RED button has been pressed at startup; if so, just display MAC address in status line, and after another press of RED button (or after time-out) re-boot
delay(250);
if (digitalRead(volButtonPin) == LOW) {     // RED eas pressed at start-up
