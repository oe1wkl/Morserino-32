...
const String prefOption[] = { "Encoder Click", "Tone Pitch Hz", "Paddle:      ", "Paddle Polar.", 
 ...
 prefPos echoPlayerOptions[] = {posClicks, posPitch, posExtPaddles, posPolarity, posLatency, posCurtisMode, posCurtisBDahTiming, posCurtisBDotTiming, posACS,
                                    posEchoToneShift, posInterWordSpace, posInterCharSpace, posRandomFile, posEchoRepeats,  posEchoConf, posTimeOut, posQuickStart};
 prefPos echoTrainerOptions[]= {posClicks, posPitch, posExtPaddles, posPolarity, posLatency, posCurtisMode, posCurtisBDahTiming, posCurtisBDotTiming, posACS,
                                    posEchoToneShift, posInterWordSpace, posInterCharSpace, posRandomOption, 
                                    posRandomLength, posCallLength, posAbbrevLength, posWordLength, posEchoRepeats,  posEchoConf, posSpeedAdapt, posTimeOut, posQuickStart };
 ...
 prefPos kochEchoOptions[] =   {posClicks, posPitch, posExtPaddles, posPolarity, posLatency, posCurtisMode, posCurtisBDahTiming, posCurtisBDotTiming, posACS,
                                    ...
                                    posRandomLength, posAbbrevLength, posWordLength, posEchoRepeats,  posEchoConf, posSpeedAdapt, posKochSeq, posTimeOut, posQuickStart };
 prefPos loraTrxOptions[] =    {posClicks, posPitch, posExtPaddles, posPolarity, posLatency, posCurtisMode, posCurtisBDahTiming, posCurtisBDotTiming, posACS,
                                    posEchoToneShift, posTimeOut, posQuickStart };
 ...
 prefPos allOptions[] =        { posClicks, posPitch, posExtPaddles, posPolarity, posLatency,
                                    ...
                                    posKeyTrainerMode, posLoraTrainerMode, posGoertzelBandwidth, posSpeedAdapt, posKochSeq, posTimeOut, posQuickStart};
...
// the preferences variable and their defaults
  ...
  uint8_t p_timeOut = 1;                      // time-out value: 0 = no timeout, 1 = 5 min, 2 = 10 min, 3 = 15 min
...
const String morserinoKochChars = "kmrsuaptlowi.njef0yv,g5/q9zh38b?427c1d6x@=K+-ASNV:";
...
////////////  Setup for LoRa
  ...
  /// new code for reading preferences values - we check if we have a value, and if yes, we use it; if no, we use and write a default value
    ...
    /// set up quickstart - this should oinly be done once at startup - after successful quickstart we disable it to allow normal menu operation
...
boolean checkPaddles() {
  ...
  const int debDelay = 1500;       // debounce time = 1,5  ms
        ...
        if ((t=checkEncoder())) {
            ...
            switch (pos) {
                ...
                case posTimeOut:  p_timeOut += (t+1);
                                p_timeOut = constrain(p_timeOut-1, 0, 3);
                                displayTimeOut();
                                break;
