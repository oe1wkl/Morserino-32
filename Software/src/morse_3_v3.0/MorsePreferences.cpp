...
Preferences pref;               // use the Preferences library for storing and retrieving objects
  ...
  uint8_t MorsePreferences::sidetoneVolume = 60;              // side tone volume, as a value between 0 and 100   0 -100
  ...
  uint8_t MorsePreferences::loraTrainerMode = 0;              // transmit via LoRa in generator and player mode?
                                              //  0: "No";  1: "yes"
  ...
  uint8_t MorsePreferences::vAdjust = 185;                    // correction value: 175 - 250
...
//String  MorsePreferences::kochWords[EnglishWords::WORDS_NUMBER_OF_ELEMENTS];
//unsigned int   MorsePreferences::numberOfWords;
//String MorsePreferences::kochAbbr[Abbrev::ABBREV_NUMBER_OF_ELEMENTS];
//unsigned int   MorsePreferences::numberOfAbbr;
  
//String MorsePreferences::kochChars;
        ...
        if ((t=checkEncoder())) {
            ...
            switch (pos) {
                ...
                case  posEchoConf:  MorsePreferences::echoConf = !MorsePreferences::echoConf;
                                ...
                                break;
                case  posLoraTrainerMode: MorsePreferences::loraTrainerMode += (t+2);                       // transmit lora in generator and player mode; can be 0 (no) or 1 (yes)
                                MorsePreferences::loraTrainerMode = (MorsePreferences::loraTrainerMode % 2);
                ...
                case posVAdjust:
                                ...
                                MorsePreferences::vAdjust = constrain(MorsePreferences::vAdjust, 165, 254);            
